...
id: llm-service
title: LLM Service
description: "Language model service providing competitor monitoring and messaging analysis capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for competitor monitoring and messaging analysis. Used by all skills in this skrpt.
